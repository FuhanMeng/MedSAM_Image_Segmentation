...
modality = 'NBI'  # e.g., 'Dermoscopy  内窥镜
anatomy = 'Cp'  # e.g., 'SkinCancer'  Colorectal polyps 结直肠息肉
img_name_suffix = '.png' 
gt_name_suffix = '.png' 
prefix = modality + '_' + anatomy + '_'
save_suffix = '.npy' 
image_size = 1024
img_path = '../datanbi/nbitrain/images'  # path to the images
gt_path = '../datanbi/nbitrain/labels'  # path to the corresponding annotations
npy_path = '../datanbi/npy/' + prefix[:-1]  # save npy path e.g., MedSAM/data/npy/; don't miss the `/`
