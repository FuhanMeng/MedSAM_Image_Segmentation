...
parser.add_argument('-s', '--seg_dir', default='assets/segs', type=str)
parser.add_argument('-g', '--gt_dir', default='assets/gts', type=str)
parser.add_argument('-csv_dir', default='assets/metrics/metrics.csv', type=str)
